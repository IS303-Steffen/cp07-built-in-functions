...
print(f"Formatted number: {example_number:,}")
...
print(f"Formatted number: {example_number:.2f}")
...
print(f"Formatted number: {example_percent:.0%}")
print(f"Formatted number: {example_percent:.2%}")
