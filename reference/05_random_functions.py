...
print("random.randrange():", random_num)
...
# even numbers
random_num = random.randrange(10, 31, 2)
print("random.randrange():", random_num)
...
# 6. random() - GENERATE A RANDOM FLOAT BETWEEN BETWEEN 0 and 1
# using random() generate a random float between 0 and 1
random_num = random.random() #Returns float between 0 and 1
print("random.random():", random_num)
